...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-950 text-slate-100 flex flex-col justify-between overflow-x-hidden relative selection:bg-blue-500 selection:text-white">
        ...
        <div className="lg:col-span-7 space-y-8">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-white leading-[1.15]">
              Welcome Back to <span className="bg-gradient-to-r from-blue-400 via-indigo-300 to-cyan-400 bg-clip-text text-transparent">Kenzo HRMS</span>
            </h1>
        ...
        <div className="lg:col-span-5 w-full">
          ...
          >
            ...
            <div className="space-y-2 text-center mb-6">
              ...
              <p className="text-xs text-slate-400">Enter your credentials or choose a quick demo account.</p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="flex items-center space-x-2 py-1">
                <Checkbox id="login-remember" {...register("rememberMe")} className="border-slate-700 data-[state=checked]:bg-blue-600" />
                <label htmlFor="login-remember" className="text-xs font-medium text-slate-400 cursor-pointer">
      ...
      <footer className="relative z-20 border-t border-slate-800/80 bg-slate-950/90 py-4 px-6 text-center text-xs text-slate-500 max-w-7xl w-full mx-auto">
